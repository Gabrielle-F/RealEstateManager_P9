...
class GetSearchPropertiesUseCase @Inject constructor(private val propertyRepository: PropertyRepository) {
    ...
    fun invoke(minPrice : Int, maxPrice : Int, minArea : Int, maxArea : Int, city: String?,
        ...
        return propertyRepository.getSearchProperties(minPrice, maxPrice, minArea, maxArea, city, types, rooms, availability, startDate, endDate, numberOfPictures, agentId, school, restaurants, playground, supermarket, shoppingArea, cinema)
    }
}